    ...
    <div className="bg-white w-full max-w-2xl mx-auto" id="payslip-print">
          ...
          <div>
            <div className="flex items-center gap-3 mb-1">
              <div className="w-10 h-10 bg-gold-400 rounded-lg flex items-center justify-center">
                <span className="text-navy-900 font-black text-lg">O</span>
              </div>
              <div>
                <div className="text-cream-100 font-bold text-lg leading-tight">Opay</div>
      ...
      <div className="bg-cream-100 border-t border-cream-200 px-8 py-3 flex items-center justify-between">
        <div className="text-xs text-navy-400">
          Generated by Opay &bull; Namibian Labour Act 11 of 2007 compliant &bull; PAYE per Income Tax Act (Act 24 of 1981)
        </div>
