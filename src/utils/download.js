...
export function downloadPayslipPDF(p, employee, period, company) {
  ...
  doc.text('B', M + 17, 53, { align: 'center' })
  doc.setTextColor(255, 255, 255); doc.setFontSize(16)
  doc.text('BluvoPay', M + 46, 46)
  ...
  doc.text('Generated by BluvoPay - Labour Act 11 of 2007 compliant - PAYE per Income Tax Act (Act 24 of 1981), 2026/2027 tables', M, fy + 12)
...
export function downloadReportPDF(title, columns, rows, meta = {}) {
  ...
  doc.text(title, M, 30)
  doc.setFont('helvetica', 'normal'); doc.setFontSize(9); doc.setTextColor(200, 210, 230)
  doc.text(`${meta.company || 'BluvoPay'}${meta.subtitle ? '  -  ' + meta.subtitle : ''}`, M, 46)
  autoTable(doc, {
    startY: 76,
    margin: { left: M, right: M },
    head: [columns],
